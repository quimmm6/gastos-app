...
export const DEMO_TRANSACTIONS = [
  // Juny 2026
  tx('2026-06-01', 1850.00, 'ingreso', 'Nòmina', 'Nòmina juny', 'rec-demo-01'),
  tx('2026-06-01', 750.00, 'gasto', 'Lloguer', 'Lloguer juny', 'rec-demo-02'),
  ...
  tx('2026-06-20', 750.00, 'gasto', 'Lloguer', 'Lloguer juny (inactiu)', 'rec-demo-02b', false),

  // Maig 2026
  tx('2026-05-01', 1850.00, 'ingreso', 'Nòmina', 'Nòmina maig', 'rec-demo-m01'),
  tx('2026-05-01', 750.00, 'gasto', 'Lloguer', 'Lloguer maig', 'rec-demo-m02'),
  ...
  // Abril 2026
  tx('2026-04-01', 1850.00, 'ingreso', 'Nòmina', 'Nòmina abril', 'rec-demo-a01'),
  tx('2026-04-01', 750.00, 'gasto', 'Lloguer', 'Lloguer abril', 'rec-demo-a02'),
